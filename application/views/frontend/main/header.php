...
<head>
    ...
    <!-- Main Style -->
    <link id="main-style" rel="stylesheet" href="assets/css/style-orange.css">
...
<li>
    <a href="http://themeforest.net/user/SoapTheme/portfolio?ref=SoapTheme"><i class="soap-icon-shopping"></i> BUY</a>
</li>
</ul>
</nav>
            ...
            <div class="col-xs-6">
                <div class="col-xs-3">
                    <div class="datepicker-wrap transparent">
                        <input type="text" class="input-text white-bg full-width check-in" name="checkin" placeholder="Check In" />
                    </div>
                </div>
                <div class="col-xs-3">
                    <div class="datepicker-wrap transparent">
                        <input type="text" class="input-text white-bg full-width check-out" name="checkout" placeholder="Check Out" />
                    </div>
                </div>
                <div class="col-xs-3">
