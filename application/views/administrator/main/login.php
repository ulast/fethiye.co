...
<head>
    <meta charset="utf-8"/>
    <title>fethiye.co | Administrator Login</title>
    ...
    <link href="assets/administrator/css/pages/login.css" rel="stylesheet" type="text/css"/>
...
<form class="login-form" action="" method="post">
    ...
    if($login != NULL)
    {
        echo '<div class="alert alert-danger"><button class="close" data-close="alert"></button><span>'. $login .'</span></div>';
    }
    ?>
...
<script src="assets/administrator/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="assets/administrator/scripts/custom/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
